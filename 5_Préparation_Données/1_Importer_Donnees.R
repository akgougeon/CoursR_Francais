...
mon_csv = read.csv("5_Advanced_Data_Wrangling/test_data/tb.csv", sep = "," , header = T, quote = "\"", na.strings = c("NA", " ", "999"), stringsAsFactors = F)
...
my_excel = read_excel("5_Advanced_Data_Wrangling/test_data/tb.xlsx", sheet = "tb")
...
test_sas = read_sas("5_Advanced_Data_Wrangling/test_data/fake_census_test_file.sas7bdat")
