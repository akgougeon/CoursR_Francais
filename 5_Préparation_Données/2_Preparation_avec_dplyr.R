...
US_data = filter(tb_data, pays == "United States of America" & adultes >0 ) # on peut combiner des critères!
...
mes_colonnes =  c("adultes", "enfants", "pers_agees") # voyez comme ceci ne fait que créer un objet vecteur... ça n'extraie pas les colonnes de la base de données
